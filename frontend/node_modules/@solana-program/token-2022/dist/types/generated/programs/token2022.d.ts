...
export declare enum Token2022Instruction {
    ...
    InitializeTokenMetadata = 75,
    UpdateTokenMetadataField = 76,
    RemoveTokenMetadataKey = 77,
    UpdateTokenMetadataUpdateAuthority = 78,
    EmitTokenMetadata = 79,
    InitializeTokenGroup = 80,
    UpdateTokenGroupMaxSize = 81,
    UpdateTokenGroupUpdateAuthority = 82,
    InitializeTokenGroupMember = 83
}
