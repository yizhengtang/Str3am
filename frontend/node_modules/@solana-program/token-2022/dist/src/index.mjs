...
function identifyToken2022Instruction(instruction) {
  ...
  if (containsBytes(
    ...
    return 75 /* InitializeTokenMetadata */;
  }
  if (containsBytes(
    data,
    ...
    return 76 /* UpdateTokenMetadataField */;
  }
  if (containsBytes(data, new Uint8Array([234, 18, 32, 56, 89, 141, 37, 181]), 0)) {
    return 77 /* RemoveTokenMetadataKey */;
  }
  if (containsBytes(
    data,
    ...
    return 78 /* UpdateTokenMetadataUpdateAuthority */;
  }
  if (containsBytes(
    data,
  ...
  if (containsBytes(
    ...
    return 81 /* UpdateTokenGroupMaxSize */;
  }
  if (containsBytes(
    data,
    ...
    return 82 /* UpdateTokenGroupUpdateAuthority */;
  }
  if (containsBytes(
    data,
    ...
    return 83 /* InitializeTokenGroupMember */;
  }
  throw new Error(
